...
def main():
    ...
    time_passed = datetime.datetime.now() - datetime.datetime.fromtimestamp(path.getmtime("textfile.txt"))
    print("It has been", time_passed, "since the file was modified.")
    print("Or,", time_passed.total_seconds(), "seconds")
